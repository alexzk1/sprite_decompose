 ...
 * Getter / Setter
 */
void Animation::setTitle(const QString &title)
{
    m_title = title;
}

void Animation::setBackground(QPixmap background)
{
    m_background = std::move(background);
}

void Animation::setMagnetism(bool magnetism)
{
    m_magnetism = magnetism;
}

void Animation::setMarks(QList<QPointer<Mark>> *marks)
{
    m_marks = marks;
}
...
void Animation::addCut(Cut *cut)
{
    m_cuts.append(cut);
}

bool Animation::magnetism() const
{
    return m_magnetism;
}

QString Animation::title() const
{
    return m_title;
}
